                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                ...
                                @else
                                    <div class="pull-left">
                                        <a href="javascript:;" class="btn btn-default btn-flat">{{ trans('list.profile') }}</a>
                                    </div>
                                @endif
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li {!! (Request::is('/') ? 'class="active"' : '') !!}>
                    <a href="{{ URL::to('/') }}"><i class="fa fa-tachometer"></i> <span>dashboard</span></a>
                </li>
                <li {!! (Request::is('companies') ? 'class="active"' : '') !!}>
                    <a href="{{ url('/companies') }}"><i class="fa fa fa-building-o"></i> <span>companies</span></a>
                </li>
                @if(Auth::user()->isImpersonating())
                    <li>
                        <a href="{{ url('/manager') }}"><i class="fa fa-link"></i> <span>Switch to Manager</span></a>
                    </li>
                @endif
            </ul>
            <!-- /.sidebar-menu -->
