...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="{{ URL::to('/') }}" class="logo">
            ...
            <span class="logo-lg"><b>M</b>K</span>
        </a>
        ...
        <nav class="navbar navbar-static-top" role="navigation">
            ...
            <a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button">
                <span class="sr-only">Ttoggle Navigation</span>
            </a>
            <!-- Navbar Right Menu -->
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                ...
                                @if(Auth::user()->isImpersonating())
                                    <div class="pull-left">
                                        <a href="{{ URL::to('/users/stop', Auth::user()->user_type) }}" class="btn btn-default btn-flat">Logout Manager</a>
                                    </div>
                                @else
                                    <div class="pull-left">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li {!! (Request::is('manager') ? 'class="active"' : '') !!}>
                    <a href="{{ URL::to('/manager') }}"><i class="fa fa-tachometer"></i> <span>Manager Dashboard</span></a>
                </li>
                <li {!! (Request::is('customers') || Request::is('customers/*') ? 'class="active"' : '') !!}>
                    <a href="{{ URL::route('customers') }}"><i class="fa fa-folder"></i> <span>Customers and Projects</span></a>
                </li>
                <li class="treeview {!! (Request::is('settings') || Request::is('settings/*') ? 'active' : '') !!}">
                    ...
                    <ul class="treeview-menu">
                        <li {!! (Request::is('settings/user') ? 'class="active"' : '') !!}><a href="{{ URL::route('listDrivers') }}"><i class="fa fa-user"></i> <span>Manage User</span></a></li>
                        <li {!! (Request::is('settings/company') ? 'class="active"' : '') !!}><a href="{{ URL::route('getCompany') }}"><i class="fa fa-building-o"></i> <span>Manage Company</span></a></li>
                    </ul>
                </li>
                @if(Auth::user()->isImpersonating())
                    <li>
                        <a href="{{ url('/') }}"><i class="fa fa-link"></i> <span>Back to Admin</span></a>
                    </li>
                @endif
            </ul>
            <!-- /.sidebar-menu -->
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2017 <a href="#">MK</a>.</strong> All rights reserved.
    </footer>
