                ...
                <div class="box-body">
                    <table id="example2" class="table table-bordered table-hover">
                        ...
                        <tr dir-paginate="record in Users|orderBy:sortKey:reverse|filter:search|itemsPerPage:10">
                            ...
                            <td>@{{ record.email }}</td>
                            <td>@{{ record.user_type == 3 ?  'Company User' :  'Administrator' }}</td>
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content border-radius">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title" ng-if="newData.id">Update User</h4>
                            ...
                            <div class="modal-body">
                                <form ng-submit="submitForm()" class="form-horizontal" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="password" class="form-control" name="password" ng-model="newData.password" placeholder="Password" ng-if="newData.id">
                                            <input type="password" class="form-control" name="password" ng-model="newData.password" placeholder="Password" ng-if="!newData.id" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-sm-4" for="password_confirmation">{{trans('list.confirmPassword')}}:</label>
                                        <div class="col-sm-8">
                                            <input type="password" class="form-control" name="password_confirmation" ng-model="newData.password_confirmation" placeholder="Confirm Password" ng-if="newData.id">
                                            <input type="password" class="form-control" name="password_confirmation" ng-model="newData.password_confirmation" placeholder="Confirm Password" ng-if="!newData.id" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
